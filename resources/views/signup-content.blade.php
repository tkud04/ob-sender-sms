                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-primary">
                            ...
                            <div class="card-body">
                                <form action="{{url('singup')}}" method="post" enctype="multipart/form-data">
								   <input type="hidden" id="uuu" name="_token" value="{{csrf_token()}}">
                                    <div class="form-body">
                                        <h3 class="card-title m-t-15">Sign up</h3>
                                        <hr>
											...
											<div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="control-label">Confirm password</label>
                                                     <input type="password"  name="pass_confirmation" class="form-control" placeholder="Password again">
                                                    <small id="error-pass" class="form-control-feedback text-danger"> This field is required. </small>  
											    </div><br>		
                                            </div>
                                            <!--/span--> 
                                    ...
                                    <div class="form-actions">
                                        <button type="submit" class="btn btn-success"> <i class="fa fa-check"></i> Sign up</button>
                                    </div>
                                </form>
                            </div>
                        </div>
